                ...
                <div className="fz-2-section-heading">
                    <div className="row gy-4 justify-content-between align-items-center">
                        <div className="col-lg-5 col-md-6">
                            <h2 className="fz-section-title">Shop by <br/> <span>Island</span></h2>
                        </div>
                ...
                <div className="row gy-4 g-2 g-sm-4 justify-content-center">
                    <div className="col-4">
                        <div className="fz-single-category">
                            ...
                            <div className="fz-single-category__txt">
                                <h5><Link to="/shop">Luzon <span className="fz-category-amount">(24)</span></Link></h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-4">
                        <div className="fz-single-category second-category d-flex flex-column-reverse justify-content-between">
                            ...
                            <div className="fz-single-category__txt">
                                <h5><Link to="/shop">Visayas <span className="fz-category-amount">(20)</span></Link></h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-4">
                        <div className="fz-single-category">
                            ...
                            <div className="fz-single-category__txt">
                                <h5>
                                    <Link to="/shop">Mindanao <span className="fz-category-amount">(30)</span></Link>
                                </h5>
                            </div>
                        </div>
                    </div>
